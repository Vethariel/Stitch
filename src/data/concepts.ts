...
export const concepts: Concept[] = [
  ...
  {
    id: "concepcion-erronea",
    label: "Concepción errónea",
    en: "Misconception",
    cluster: "cognitivo",
    definition:
      "Idea o modelo previo sobre un dominio que el aprendiz sostiene con convicción pero que es inadecuado o falso; a diferencia de una laguna (ausencia), está activo y orienta la interpretación —si no se trabaja, se consolida y dificulta el aprendizaje nuevo.",
  },
  {
    id: "condicionalizacion",
    label: "Condicionalización",
    en: "Conditionalized knowledge",
    cluster: "cognitivo",
    definition:
      "Propiedad del conocimiento bien aprendido: saber no solo qué es o cómo se hace, sino en qué condiciones aplica y en cuáles no; sin condicionalización, el saber tiende a permanecer inerte.",
  },
  {
    id: "transferencia-negativa",
    label: "Transferencia negativa",
    en: "Negative transfer",
    cluster: "desempeno",
    definition:
      "Arrastre de un patrón, estrategia o conocimiento previo a una situación donde resulta ineficaz o engañoso; contraparte de la transferencia útil y riesgo central cuando se reutiliza sin contrastar el contexto.",
  },
  {
    id: "pericia-adaptativa",
    label: "Pericia adaptativa",
    en: "Adaptive expertise",
    cluster: "cognitivo",
    definition:
      "Forma de pericia que no solo ejecuta con eficacia procedimientos conocidos, sino que replantea el problema, flexibiliza el enfoque y genera soluciones nuevas cuando el enunciado o el contexto cambian (frente a una pericia rutinaria más rígida).",
  },
  {
    id: "modelo-mental",
    label: "Modelo mental",
    ...
    cluster: "cognitivo",
    definition:
      "Representación organizada que el aprendiz construye de un dominio —principios, relaciones y condiciones de uso— que permite interpretar situaciones nuevas, recuperar lo pertinente y orientar la acción; se distingue de una acumulación de datos sueltos.",
  },
  {
    id: "novato-logrado",
    label: "Novato logrado",
    en: "Accomplished novice",
    cluster: "self",
    definition:
      "Postura de quien ha alcanzado méritos en un dominio pero se mantiene abierto a aprender como novato ante lo nuevo, en lugar de cerrar la identidad de «experto»; encaja con el aprendizaje de por vida y con la pericia adaptativa.",
  },
  {
    id: "conocimiento-pedagogico",
    label: "Conocimiento pedagógico del contenido",
    en: "Pedagogical content knowledge",
    cluster: "acto",
    definition:
      "Saber que combina el dominio con la comprensión de cómo lo aprenden los novatos: dificultades típicas, ideas erróneas frecuentes y formas de representación que ayudan a enseñarlo; ser experto en el tema no lo garantiza por sí solo.",
  },
];
...
export const conceptEdges: ConceptEdge[] = [
  ...
  { from: "concepcion-erronea", to: "conocimiento-previo", kind: "es_tipo" },
  { from: "concepcion-erronea", to: "lagunas-aprendizaje", kind: "tensiona" },
  { from: "concepcion-erronea", to: "creencia", kind: "informa" },
  { from: "concepcion-erronea", to: "comprension", kind: "tensiona" },
  { from: "concepcion-erronea", to: "transferencia", kind: "tensiona" },
  { from: "instruccion", to: "concepcion-erronea", kind: "tensiona" },
  { from: "retroalimentacion", to: "concepcion-erronea", kind: "informa" },
  { from: "condicionalizacion", to: "conocimiento", kind: "informa" },
  { from: "condicionalizacion", to: "conocimiento-inerte", kind: "tensiona" },
  { from: "condicionalizacion", to: "transferencia", kind: "permite" },
  { from: "condicionalizacion", to: "contexto", kind: "orienta" },
  { from: "instruccion", to: "condicionalizacion", kind: "orienta" },
  { from: "transferencia-negativa", to: "transferencia", kind: "tensiona" },
  { from: "transferencia-negativa", to: "estrategia-aprendizaje", kind: "informa" },
  { from: "analogia", to: "transferencia-negativa", kind: "dispara" },
  { from: "patron", to: "transferencia-negativa", kind: "dispara" },
  { from: "condicionalizacion", to: "transferencia-negativa", kind: "tensiona" },
  { from: "metacognicion", to: "transferencia-negativa", kind: "regula" },
  { from: "pericia-adaptativa", to: "pericia", kind: "es_tipo" },
  { from: "pericia-adaptativa", to: "transferencia", kind: "permite" },
  { from: "pericia-adaptativa", to: "resolucion-problemas", kind: "orienta" },
  { from: "pericia-adaptativa", to: "metacognicion", kind: "informa" },
  { from: "modelo-mental", to: "conocimiento", kind: "orienta" },
  { from: "modelo-mental", to: "comprension", kind: "permite" },
  { from: "modelo-mental", to: "integracion-conocimiento", kind: "informa" },
  { from: "modelo-mental", to: "patron", kind: "orienta" },
  { from: "modelo-mental", to: "transferencia", kind: "permite" },
  { from: "relacion", to: "modelo-mental", kind: "informa" },
  { from: "novato-logrado", to: "pericia-adaptativa", kind: "orienta" },
  { from: "novato-logrado", to: "agencia", kind: "orienta" },
  { from: "novato-logrado", to: "maestria", kind: "tensiona" },
  { from: "novato-logrado", to: "metacognicion", kind: "informa" },
  { from: "conocimiento-pedagogico", to: "instruccion", kind: "orienta" },
  { from: "conocimiento-pedagogico", to: "andamiaje", kind: "orienta" },
  { from: "conocimiento-pedagogico", to: "concepcion-erronea", kind: "informa" },
  { from: "conocimiento-pedagogico", to: "pericia", kind: "tensiona" },
  { from: "conocimiento-pedagogico", to: "evaluacion-formativa", kind: "permite" },
];
